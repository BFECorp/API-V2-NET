<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutStoreGetOrder.aspx.cs" Inherits="Chukou1Demo.Aspnet.OutStoreGetOrder" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>OutStoreGetOrder Sample</title>
    <style type="text/css">
        .style1
        {
            height: 30px;
		...
		<table align="center" style="font-size: large">
			<tr>
				<td colspan="3" class="style1" align="center" width="408">
					<div class="header"><b>OutStoreGetOrder Sample</b></div>
				</td>
			</tr>
		</table>
		<br />
