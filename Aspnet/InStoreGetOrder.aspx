<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InStoreGetOrder.aspx.cs" Inherits="Chukou1Demo.Aspnet.InStoreGetOrder" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>InStoreGetOrder Sample</title>
    <style type="text/css">
        .style1
        {
            height: 30px;
    ...
    <form id="Form1" runat="server">
		<table align="center" style="font-size: large">
			<tr>
				<td colspan="3" class="style1" align="center" width="408">
					<div class="header"><b>InStoreGetOrder Sample</b></div>
				</td>
			</tr>
		</table>
		<br />
        ...
        <asp:Panel ID="pnlResponse" runat="server">
		    ...
		    <table align="center" style="font-size: small">
		        ...
		        <tr>
                    <td class="style3" width="200">ArriveTime</td>
                    <td class="style2">
                        <asp:Label ID="lblArriveTime" runat="server" Text=" "></asp:Label></td>
                </tr>
                <tr>
                    <td class="style3" width="200">CaseList</td>
                    <td class="style2">
                        <asp:Label ID="lblCaseList" runat="server" Text=" "></asp:Label></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="style3" width="200">PickUpAddress</td>
                    <td class="style2">
                        <asp:Label ID="lblPickUpAddress" runat="server" Text=" "></asp:Label></td>
                </tr>
                <tr>
                    <td class="style3" width="200">PickupType</td>
                    <td class="style2">
                        <asp:Label ID="lblPickupType" runat="server" Text=" "></asp:Label></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="style3" width="200">ShippingMethod</td>
                    <td class="style2">
                        <asp:Label ID="lblShippingMethod" runat="server" Text=" "></asp:Label></td>
                </tr>
                <tr>
                    <td class="style3" width="200">State</td>
                    <td class="style2">
                        <asp:Label ID="lblState" runat="server" Text=" "></asp:Label></td>
                </tr>
                <tr>
                    <td class="style3" width="200">Warehouse</td>
                    <td class="style2">
                        <asp:Label ID="lblWarehouse" runat="server" Text=" "></asp:Label></td>
                </tr>
                <tr>
                    <td style="text-align: right">
