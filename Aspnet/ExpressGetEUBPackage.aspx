<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpressGetEUBPackage.aspx.cs" Inherits="Chukou1Demo.Aspnet.ExpressGetEUBPackage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>ExpressGetEUBPackage Sample</title>
    <style type="text/css">
        .style1
        {
            height: 30px;
    ...
    <form id="Form1" runat="server">
		<table align="center" style="font-size: large">
			<tr>
				<td colspan="3" class="style1" align="center" width="408">
					<div class="header"><b>ExpressGetEUBPackage Sample</b></div>
				</td>
			</tr>
		</table>
		<br />
        ...
        <asp:Panel ID="pnlResponse" runat="server">
		    ...
		    <table align="center" style="font-size: small">
                ...
                <tr>
                    <td class="style3" width="200">PackageDetail</td>
                    <td class="style2">
                        <asp:Label ID="lblPackageDetail" runat="server" Text=" "></asp:Label></td>
                </tr>
                <tr>
                    <td class="style3" width="200">PackUpAddress</td>
                    <td class="style2">
                        <asp:Label ID="lblPackUpAddress" runat="server" Text=" "></asp:Label></td>
                </tr>
                <tr>
